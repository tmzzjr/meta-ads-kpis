...
export const KPI_DEFINITIONS = {
  ...
  conversions:     { label: 'Conversions',      format: 'integer'  },
  cost_per_result: { label: 'Cost per Result',  format: 'currency' },
...
const LOWER_IS_BETTER = new Set(['cpc', 'cpm', 'cost_per_result', 'frequency']);
