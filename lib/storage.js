...
export const STORAGE_KEYS = {
  ...
  // Anthropic API key for the AI analyst (local only, never synced)
  ANTHROPIC_KEY: 'anthropic_key',
  // Set while the user is off in the Anthropic console fetching a key, so the
  // popup reopens straight into the paste step instead of losing the flow
